...
contract MatchToken is TRC20 {
    ...
    function mine(address _player, address _gameDevs, address _channelPartner, uint256 value) public {
        ...
        _balances[luxeTokenAddress] = _balances[luxeTokenAddress].add(toBeMined.mul(15).div(100));
        _balances[_gameDevs] = _balances[_gameDevs].add(toBeMined.mul(10).div(100));
        _balances[_channelPartner] = _balances[_channelPartner].add(toBeMined.mul(20).div(100));
        _balances[prizePool] = _balances[prizePool].add(toBeMined.mul(5).div(100));
